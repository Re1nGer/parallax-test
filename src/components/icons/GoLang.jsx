...
{/*
        <img src={ReduxBlur.src} className="group-active:opacity-100 transition-opacity max-w-[30px] max-h-[40px] h-full w-full top-2.5 scale-150 opacity-75 absolute z-0" alt="golang blur" />
*/}
    </div>
