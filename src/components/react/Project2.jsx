...
const Project2 = ({ onClick }) => {
   ...
   return <div className="flex justify-start w-full pl-6" onClick={onClick}>
           <div className="group max-w-[160px] flex h-[88px] relative">
               <div
                   className="group-active:opacity-0 transition-opacity absolute z-[1] flex flex-col max-w-[100px] mt-1 ml-4 h-full justify-center items-center">
                   <h3 className="text-dark_blue text-[15px] uppercase font-valorax">Project</h3>
                   <h3 className="text-dark_blue text-[15px] font-bold font-valorax">#2</h3>
               </div>
               <svg className="group-active:stroke-[5px] active:-translate-x-4 transition-all" width="150" height="96"
               ...
               <svg
                   ...
                   <g filter="url(#filter0_d_138_26)">
                       <path d="M21.5211 3.40881H3.60254V36.4893L26.0008 58.0261V8.06076L21.5211 3.40881Z"
                             fill="#232323" fillOpacity="0.8" shapeRendering="crispEdges"/>
                       <path d="M21.5211 3.40881H3.60254V36.4893L26.0008 58.0261V8.06076L21.5211 3.40881Z"
                             stroke="#97E9FF" shapeRendering="crispEdges"/>
                   </g>
